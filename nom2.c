...
int main(){
	...
	double discriminant = b * b - 4 * a * c; //считаем дискриминант

	//Рассматриваем различные случаи, когда каждый коэффициент квадратного уравнения либо нулевой, либо ненулевой.
	//В каждом случае выводим на экран, есть ли корни, сколько их. Если корни есть, считаем их и выводим. Если нет, пишем, что их нет  
